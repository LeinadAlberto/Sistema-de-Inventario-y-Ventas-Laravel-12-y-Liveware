@php
    $links = [
        [
            ...
            'active' => request()->routeIs('admin.dashboard') // Retorna true o false segun se este en ese enlace
        ],
        [
        ...
        [
            ...
            'icon' => 'fa-solid fa-gauge', 
            'href' => route('admin.dashboard'), 
            'active' => false, // Retorna true o false segun se este en ese enlace
            'submenu' => [
                [
                    'name' => 'Products', 
                    'href' => '#', 
                        ...
                        @isset($link['submenu'])
                            ...
                            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                                @foreach ($link['submenu'] as $item)
                                    <li>
                                        <a href="{{ $item['href'] }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Products</a>
                                    </li>
                                @endforeach
                            </ul>
                        @else
